...
app.post("/signup", async (req, res) => {
  try {
    const { password, email, firstName, lastName, adresse } = req.body;
    ...
    const ordersCollection = collection(db, "achats");
    ...
    const data: any = {
      ...
      subject: "Leafy vous souhaite la bienvenue",
      text: `${firstName} ${lastName}, l'équipe de Leafy vous souhaite le bienvenue!`,
      html: `<div><h1>Bienvenue</h1><p>${firstName} ${lastName}, toute l'équipe de Leafy vous souhaite la bienvenue!</p></div>`,
    };
